...
export default function CTAFinal() {
  ...
  return (
    <section
      id="contacto"
      className="relative bg-[#0F0E0D] py-24 md:py-32 overflow-hidden"
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse at 50% 50%, rgba(232,160,32,0.12) 0%, transparent 60%)',
        }}
        aria-hidden="true"
      />
      ...
      >
        ...
        >
          <h2
            className="font-display font-extrabold text-[#F2EDE8] mb-6"
        ...
        >
          <p className="font-body text-[16px] md:text-[17px] text-[#9C9490] leading-[1.7] mb-10">
        ...
        >
          <a
            ...
            className="
              ...
              font-display font-bold text-[16px] md:text-[17px] text-[#0F0E0D]
        ...
        >
          <div className="flex items-center justify-center gap-2">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#9C9490" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
            </svg>
            <p className="font-body text-[13px] text-[#9C9490] text-center">
        ...
        {/* Contact details */}
        <div
          className={`mt-8 pt-8 border-t border-[#2E2C2A] flex flex-col sm:flex-row items-center justify-center gap-4 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
          style={{ transitionDelay: '500ms' }}
        >
          <a
            href="mailto:hola@eqko.mx"
            className="flex items-center gap-2 font-body text-[14px] text-[#9C9490] hover:text-[#F2EDE8] transition-colors"
          >
          ...
          <span className="hidden sm:block text-[#2E2C2A]">·</span>
          <span className="font-body text-[13px] text-[#9C9490]">

...
function ServiceCard({ service, index, visible }) {
  return (
    <article
      className={`
        ...
        ${service.featured
          ...
          : 'border-[var(--color-linea)] bg-[var(--color-grafito)] hover:bg-[var(--color-piedra)]'
        }
    ...
    >
      ...
      {service.featured && (
        <div
          className="absolute -top-3 left-5 px-3 py-1 rounded-full text-[11px] font-display font-bold text-[var(--color-carbono)] bg-[var(--color-amber)]"
      ...
      {/* Icon */}
      <div
        className={`w-10 h-10 rounded-xl flex items-center justify-center mb-4 text-[var(--color-amber)] ${
      ...
      {/* Name */}
      <h3 className="font-display font-semibold text-[17px] text-[var(--color-crema)] mb-2.5 leading-[1.3]">
        {service.name}
      </h3>

      {/* Description */}
      <p className="font-body text-[14px] text-[var(--color-niebla)] leading-[1.6] flex-1 mb-5">
        {service.description}
      </p>

      {/* Result tag */}
      <div className="flex items-start gap-2">
        <div className="w-4 h-4 shrink-0 mt-0.5 text-[var(--color-amber)]">
          <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M13.5 4.5L6.5 11.5L2.5 7.5"/>
          </svg>
        </div>
        <span className="font-body text-[13px] text-[var(--color-amber)] leading-[1.5]">
          {service.tag}
        </span>
      </div>
    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-8">
        ...
        >
          ...
          <h2
            className="font-display font-bold text-[var(--color-crema)] max-w-[680px] mb-4"
          ...
          <p className="font-body text-[16px] md:text-[17px] text-[var(--color-niebla)] max-w-[520px] leading-[1.7]">
